...
<!-- Copy to .cursor/rules/package-json-scripts.md on scaffold — @see .agents/skills/tech-stack/references/package-json-scripts.md -->
...
| `check-pre-push` | husky — parallel leaves plus strict `knip` |
...
Existing pipeline CLIs (`extract:osm`, `rust:build`, `german-key-lookup:update`) predate this rule and stay as operator-facing names; do not treat them as Bun glob groups.
