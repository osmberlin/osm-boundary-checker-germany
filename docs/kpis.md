...
| Hausdorff P95 (m, robust)    | [`scripts/compare/lib/metrics/issueIndicator.ts`](../scripts/compare/lib/metrics/issueIndicator.ts)                             | [`scripts/compare/lib/metrics/hausdorff/de.ts`](../scripts/compare/lib/metrics/hausdorff/de.ts)                       |
| KPI issue indicator (triage) | [`scripts/compare/lib/metrics/issueIndicator.ts`](../scripts/compare/lib/metrics/issueIndicator.ts)                             | [`scripts/compare/lib/metrics/issue-indicator/de.ts`](../scripts/compare/lib/metrics/issue-indicator/de.ts)           |
