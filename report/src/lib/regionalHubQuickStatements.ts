export function regionalHubQuickStatementsV1Url(command: string) {
...
export function osmRelationP402QuickStatement(qid: string, osmRelationId: string) {
...
export function osmRelationP402QuickStatementsUrl(qid: string, osmRelationId: string) {
  return regionalHubQuickStatementsV1Url(osmRelationP402QuickStatement(qid, osmRelationId))
}

export function wikidataItemUrl(qid: string, hash?: 'P1082' | 'P402') {
